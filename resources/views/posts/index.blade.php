...
{{-- <nav aria-label="Page navigation example">
    <ul class="pagination">
      ...
      <li class="page-item"><a class="page-link" href="{{$posts-links()}}">2</a></li>
      <li class="page-item"><a class="page-link" href="{{$posts-links()}}">3</a></li>
      <li class="page-item"><a class="page-link" href="{{$posts-links()}}">Next</a></li>
    </ul>
  </nav> --}}
    {{$posts->links()}}
@endsection
